...
X = np.array([0xF0, 0xB6, 0xE2, 0x3F, 0x1A, 0x37, 0xB2, 0x28], dtype='B')
m0 = 0xE0
m1 = 0x3B
m2 = 0xDB

print('S-Box in: ' + hex(X[0])[2:] + ' ' + hex(X[1])[2:] + ' ' +  hex(X[2])[2:] + ' ' +  hex(X[3])[2:] + ' ' +  hex(X[4])[2:] + ' ' +  hex(X[5])[2:] + ' ' +  hex(X[6])[2:] + ' ' +  hex(X[7])[2:])
slayer(X, m0, m1, m2)
print('S-Box out: ' + hex(X[0])[2:] + ' ' + hex(X[1])[2:] + ' ' +  hex(X[2])[2:] + ' ' +  hex(X[3])[2:] + ' ' +  hex(X[4])[2:] + ' ' +  hex(X[5])[2:] + ' ' +  hex(X[6])[2:] + ' ' +  hex(X[7])[2:])
print('HW = ' + str(HW(X[0])))
...
np.savetxt('plaintexts.txt', plaintexts, fmt='%i')
print('Done')
print(' ')
...
np.savetxt('matrix_H.txt', matrix_H)
...
np.savetxt('correlation_coefficients.txt', matrix_p_i_j)
print('Done')
print(' ')
