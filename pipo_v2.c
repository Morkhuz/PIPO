...
void pipo128 (uint64_t plain) {
    ...
    uint8_t k_0_128[8];
    k_0_128[0] = (k0_128 >> 0) & 0xFF;
    k_0_128[1] = (k0_128 >> 8) & 0xFF;
    k_0_128[2] = (k0_128 >> 16) & 0xFF;
    k_0_128[3] = (k0_128 >> 24) & 0xFF;
    k_0_128[4] = (k0_128 >> 32) & 0xFF;
    k_0_128[5] = (k0_128 >> 40) & 0xFF;
    k_0_128[6] = (k0_128 >> 48) & 0xFF;
    k_0_128[7] = (k0_128 >> 56) & 0xFF;

    uint8_t k_1_128[8];
    k_1_128[0] = (k1_128 >> 0) & 0xFF;
    k_1_128[1] = (k1_128 >> 8) & 0xFF;
    k_1_128[2] = (k1_128 >> 16) & 0xFF;
    k_1_128[3] = (k1_128 >> 24) & 0xFF;
    k_1_128[4] = (k1_128 >> 32) & 0xFF;
    k_1_128[5] = (k1_128 >> 40) & 0xFF;
    k_1_128[6] = (k1_128 >> 48) & 0xFF;
    k_1_128[7] = (k1_128 >> 56) & 0xFF;
...
void pipo256 (uint64_t plain) {
    ...
    uint8_t k_0_256[8];
    k_0_256[0] = (k0_256 >> 0) & 0xFF;
    k_0_256[1] = (k0_256 >> 8) & 0xFF;
    k_0_256[2] = (k0_256 >> 16) & 0xFF;
    k_0_256[3] = (k0_256 >> 24) & 0xFF;
    k_0_256[4] = (k0_256 >> 32) & 0xFF;
    k_0_256[5] = (k0_256 >> 40) & 0xFF;
    k_0_256[6] = (k0_256 >> 48) & 0xFF;
    k_0_256[7] = (k0_256 >> 56) & 0xFF;

    uint8_t k_1_256[8];
    k_1_256[0] = (k1_256 >> 0) & 0xFF;
    k_1_256[1] = (k1_256 >> 8) & 0xFF;
    k_1_256[2] = (k1_256 >> 16) & 0xFF;
    k_1_256[3] = (k1_256 >> 24) & 0xFF;
    k_1_256[4] = (k1_256 >> 32) & 0xFF;
    k_1_256[5] = (k1_256 >> 40) & 0xFF;
    k_1_256[6] = (k1_256 >> 48) & 0xFF;
    k_1_256[7] = (k1_256 >> 56) & 0xFF;

    uint8_t k_2_256[8];
    k_2_256[0] = (k2_256 >> 0) & 0xFF;
    k_2_256[1] = (k2_256 >> 8) & 0xFF;
    k_2_256[2] = (k2_256 >> 16) & 0xFF;
    k_2_256[3] = (k2_256 >> 24) & 0xFF;
    k_2_256[4] = (k2_256 >> 32) & 0xFF;
    k_2_256[5] = (k2_256 >> 40) & 0xFF;
    k_2_256[6] = (k2_256 >> 48) & 0xFF;
    k_2_256[7] = (k2_256 >> 56) & 0xFF;

    uint8_t k_3_256[8];
    k_3_256[0] = (k3_256 >> 0) & 0xFF;
    k_3_256[1] = (k3_256 >> 8) & 0xFF;
    k_3_256[2] = (k3_256 >> 16) & 0xFF;
    k_3_256[3] = (k3_256 >> 24) & 0xFF;
    k_3_256[4] = (k3_256 >> 32) & 0xFF;
    k_3_256[5] = (k3_256 >> 40) & 0xFF;
    k_3_256[6] = (k3_256 >> 48) & 0xFF;
    k_3_256[7] = (k3_256 >> 56) & 0xFF;
