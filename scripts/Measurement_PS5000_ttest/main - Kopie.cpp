...
const unsigned long int PostTriggerSamples = 868; // and this
	...
	//******************************************************************//
        ...
        for(int i = 0; i < 8; i++)
        {
            if (X[i] != ciphertext[i])
            {
                ...
                printf("X          = %2X %2X %2X %2X  %2X %2X %2X %2X\n", X[7], X[6], X[5], X[4], X[3], X[2], X[1], X[0]);
                printf("ciphertext = %2X %2X %2X %2X  %2X %2X %2X %2X\n", ciphertext[7], ciphertext[6], ciphertext[5], ciphertext[4], ciphertext[3], ciphertext[2], ciphertext[1], ciphertext[0]);
                return -4;
            }
        }
